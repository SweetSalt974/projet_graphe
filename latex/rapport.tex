...
Cet algorithme garantit le fait de trouver une solution optimale, mais le nombre de permutations cro\^it rapidement avec le nombre de d\'echets \`a ramasser. Par exemple, pour 10 d\'echets, il y a plus de 3,6 permutations possibles. Ainsi, l'algorithme force brute reste inefficace pour les instances de grande taille.
